...
spec = do
    describe "solver" $ do
        ...
        it "Solves notakto of 5 moves" $ do
            solve "{\"c\": {\"0\": 0, \"1\": 0}, \"v\": \"x\", \"id\": \"gjTpfcCNvFIlewtwIKRrhiVtKEBqXL\", \"prev\": {\"c\": {\"0\": 1, \"1\": 2}, \"v\": \"x\", \"id\": \"n\", \"prev\": {\"c\": {\"0\": 2, \"1\": 2}, \"v\": \"x\", \"id\": \"gjTpfcCNvFIlewtwIKRrhiVtKEBqXL\", \"prev\": {\"c\": {\"0\": 2, \"1\": 1}, \"v\": \"x\", \"id\": \"n\", \"prev\": {\"c\": {\"0\": 0, \"1\": 1}, \"v\": \"x\", \"id\": \"gjTpfcCNvFIlewtwIKRrhiVtKEBqXL\"}}}}}"
                `shouldBe` Right (Just (1,0,'x'))
